    ...
    <main className="min-h-dvh bg-slate-50">
      ...
      <div className="mx-auto max-w-2xl px-6 py-10">
        ...
        <p className="pt-2 text-sm leading-relaxed text-slate-600">
          A drawing documents a part without containing one. This reads the sheet down
          to an outline and what the drawing says to do with it — turn it about its
          centre line, or run it straight through at the depth a second view gives. What
          comes out is a real solid, and a guess about what the sheet meant.
        </p>
        ...
        <div className="grid gap-4 pt-6 sm:grid-cols-2">
          <div>
            ...
            <ul className="space-y-1 pt-1.5 text-xs leading-relaxed text-slate-600">
              <li>
                Turned parts: shafts, bushes, pins, spacers, stepped and flanged bodies
              </li>
              <li>
                Flat parts of constant section, drawn in two views that line up — the
                shape in one, the thickness in the other
              </li>
              <li>
                Holes and slots through a flat part: any outline closed inside the shape
                is cut out of it
              </li>
          ...
          <div>
            ...
            <ul className="space-y-1 pt-1.5 text-xs leading-relaxed text-slate-600">
              <li>
                Anything that stops partway: a blind pocket, a counterbore, a thread. A
                hole is taken to go all the way through
              </li>
              <li>Cross holes and keyways on a turned part, which are not cut</li>
              <li>
                A part that takes three views to describe, which is not one shape run
                through
              </li>
        ...
        <div className="pt-6 text-xs leading-relaxed text-slate-500">
          ...
          <p className="pt-2">
            ...
            <span className="font-medium text-slate-700">DXF</span> only for now. A PDF or
            an image of one is read as a turned part or not at all.
          </p>
        </div>
